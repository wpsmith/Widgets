<?php
/**
 * Genesis Featured Story Widget Class File
 *
...
if ( ! class_exists( __NAMESPACE__ . '\Genesis_Featured_Story' ) ) {
	/**
	 * Class Genesis_Featured_Story
	 *
	 * Genesis Featured Story widget class.
	 *
	 * @package WPS\WP\Widgets
	 */
	class Genesis_Featured_Story extends Genesis_Featured_Widget {
